...
int main() {
    ...
    if (loginu == "Default" && loginpass == "69420") {
        ...
        for (n = 1; n <= 1000; n++) {
            ...
            else if (raspuns2 == "Why is development so slow?") {
                cout << "I don't know ask that lazy developer of mine.Don't you agree?(y/n)" << endl;
                string raspuns22;
            ...
            else if (raspuns2 == "What is your favorite music?") {
                cout << "I lisen to uamee hard-bass everyday. What is your favorite band?" << endl;
                string raspuns23;
                getline(cin, raspuns23);
                cout << "Hmmm " << raspuns23 << " never heard of them might try to lisen to them sometime." << endl;
            }
            else if (raspuns2 == "/com 1") {
                cout << "Care va fi intebarea?" << endl;
                string raspuns3;
